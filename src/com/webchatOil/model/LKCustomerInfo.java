 ...
 */
@Entity
@Table(name="LKCustomerInfo")
public class LKCustomerInfo implements Serializable{
	private static final long serialVersionUID = 19L;
    private int Cu_id;   // 客户编号
    private int Cu_name;  // 客户名称
    ...
    public void setCu_name(int name){
    	this.Cu_name = name;
    }
    public int getCu_name(){
    	return this.Cu_name;
    }
